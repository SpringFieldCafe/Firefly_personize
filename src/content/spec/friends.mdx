...
export const site = {
  name: "PigGo",
  desc: "记录 AI、编程、项目实践与个人博客折腾的技术小站。",
  url: "https://springfieldcafe.github.io/404/",
  avatar: "/404/assets/images/rikkakanade.jpg",
  email: "2574703489@qq.com",
};
        ...
        <div class="space-y-0 flex-1">
          ...
          <div class="flex gap-3.5">
            ...
            <div class="pb-4">
              ...
              <p class="text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed">申请模板，把内容复制修改后到邮件中发送</p>
